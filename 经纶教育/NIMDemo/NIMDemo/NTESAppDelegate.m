...
{
    //下面是经纶教育ID
    [[PgyManager sharedPgyManager] startManagerWithAppId:@"75b0e759b807f8d81791382fcec41cd2"];
    //启动更新检查SDK
    [[PgyUpdateManager sharedPgyManager] startManagerWithAppId:@"75b0e759b807f8d81791382fcec41cd2"];
...
-(void)initData
{
    if (![[NSUserDefaults standardUserDefaults] valueForKey:USER_DEFAULT_BASEURL]) {
        [[NSUserDefaults standardUserDefaults]setValue:appUrlJL forKey:USER_DEFAULT_BASEURL];
