...
#pragma mark - 图片部分
        ...
        for (int  i = 0; i < [_imageArray count]; i++) {
            ...
            UIImageView *image = [[UIImageView alloc] initWithFrame:CGRectMake(((375 -  200)/4)*(i%3 + 1) +  40 * (i%3) , self.contentView.frame.size.height + 3 * ((i/3) + 1) + (i/3) *  80 + 10 + 10  , 80,80)];
...
//        photo.image = [imageViews objectAtIndex:i];
    ...
    //3.设置默认显示的图片索引
    brower.currentPhotoIndex = clickTag;
