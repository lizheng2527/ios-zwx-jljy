...
-(void)requestData
{
    ...
    [helper getHomeWorkPageListWithPageNum:@"1" idGrade:_idGrade idCourses:_idCourses startTime:_startTime endTime:_endTime type:_type andStatus:^(BOOL successful, NSMutableArray *dataSource) {
...
-(void)loadMoreData
{
    ...
    QCSNetHelper *helper = [QCSNetHelper new];
    [helper getHomeWorkPageListWithPageNum:[NSString stringWithFormat:@"%ld",_pageNum] idGrade:_idGrade idCourses:_idCourses startTime:_startTime endTime:_endTime type:_type andStatus:^(BOOL successful, NSMutableArray *dataSource) {
        if (!dataSource.count) {
            _pageNum--;
