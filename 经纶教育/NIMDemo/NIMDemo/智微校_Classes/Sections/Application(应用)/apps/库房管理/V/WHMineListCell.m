...
- (IBAction)signBtnDidClickAction:(id)sender {
    if (self.delegate &&[ _delegate respondsToSelector:@selector(applySignBtnDidClick:)]) {
        [_delegate applySignBtnDidClick:self];
    }
}
