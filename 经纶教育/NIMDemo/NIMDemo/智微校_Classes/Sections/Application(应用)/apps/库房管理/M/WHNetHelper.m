...
//    NSString *requestURL = [NSString stringWithFormat:@"%@%@",@"http://192.168.1.121:9999/dc-storeroom/",url_MyApplicationList];
    
    NSDictionary *dic = @{@"sys_auto_authenticate":@"true",@"sys_username":[NSString stringWithFormat:@"%@",userName],@"sys_password":password,@"id":userID,@"pageObj.pageSize":@"1000"};
