...
//
//    erweimaImageView.image = [UIImage imageNamed:@"陈经纶AppStore地址"];
...
//        pasteboard.string = [NSString stringWithFormat:@"https://itunes.apple.com/cn/app/id1457445401  ---分享自：%@(经纶教育)",userName];
...
//    UIActivityViewController *activity1 = [[UIActivityViewController alloc] initWithActivityItems:@[@"经纶教育",imageToShare,[NSURL URLWithString:@"https://itunes.apple.com/cn/app/id1457445401"]] applicationActivities:nil];
...
{
    //下面是经纶教育ID
    [[PgyUpdateManager sharedPgyManager] startManagerWithAppId:@"75b0e759b807f8d81791382fcec41cd2"];   // 请将 PGY_APP_ID 换成应用的 App ID
