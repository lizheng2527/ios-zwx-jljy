...
-(void)createLeftBar
{
    ...
    rightBtn = [[UIBarButtonItem alloc]initWithTitle:@"提交" style:UIBarButtonItemStyleDone target:self action:@selector(searchBtnClick:)];
    rightBtn.width = 0.5;
...
-(void)searchBtnClick:(id)sender
{
    ...
    if (_textField.text.length > 0) {
        ...
        [helper addFriendWithKeyWord:keyWord andDeal:^(BOOL Success, NSMutableArray *array) {
            _dataSource = array;
